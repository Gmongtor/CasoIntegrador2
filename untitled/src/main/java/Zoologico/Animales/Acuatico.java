...
public class Acuatico extends Animales {
 ...
 class ZoologicoAcuatico {
    ...
    public static void main(String[] args) {
        ...
        Acuatico delfin = new Acuatico("Delfin", 10, "Buena", "Agua Salada", "Saltar fuera del agua");
        Acuatico tiburon = new Acuatico("Tiburon", 15, "Excelente", "Agua Salada", "Nadar profundo");
        ...
        Acuatico pulpo = new Acuatico("Pulpo", 3, "Buena", "Agua Salada", "Cambio de color y forma");
        Acuatico medusa = new Acuatico("Medusa", 1, "Buena", "Agua Salada", "Natación pulsátil");

        // Mostrar información de cada animal acuático
        mostrarInformacionAnimalAcuatico(delfin);
        mostrarInformacionAnimalAcuatico(tiburon);
        ...
        mostrarInformacionAnimalAcuatico(pulpo);
        mostrarInformacionAnimalAcuatico(medusa);
    }
